...
- **禁用色域**：hard digital flat color, vector edge, 3D realism。
...
- **质感锚点**：wet-on-wet pigment, visible paper grain, feathered edge。
- **提示词基线**：(best quality, masterpiece, high detailed:1.2), (watercolor illustration style:1.3), (soft edge landscape, translucent color wash, dreamy character, paper texture:1.18), (diffused daylight, gentle bloom, low contrast:1.1), wet-on-wet pigment, visible paper grain, feathered edge, clean composition, readable silhouette, high detail, finished illustration。
