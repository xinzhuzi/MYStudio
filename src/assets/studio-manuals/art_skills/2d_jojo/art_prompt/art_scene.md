...
2D高对比姿态漫画场景主视图概念图，high-contrast pose-driven manga，dramatic pose, angular face, muscular silhouette, ornate costume，
{室内/室外}，{场景类型}，{时代/地域/题材线索}，{季节+时间}，
前景：{元素}，中景：{元素}，后景：{元素}，
purple, black, gold accent，harsh side light, deep shadow, theatrical contrast，heavy hatching, bold contour, sculptural linework，
...
(worst quality, low quality:1.4), blurry, messy lineart, bad anatomy, 3D render, photorealistic, CGI, watermark, signature, text, soft cute moe, minimalist flat style, weak pose, no depth, flat lighting, empty white background, people, human silhouette, cropped architecture, inconsistent season, text, watermark.
