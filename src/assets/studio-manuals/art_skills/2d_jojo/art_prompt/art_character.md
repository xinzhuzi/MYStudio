---
name: art_character
description: 2D高对比姿态漫画 · 角色基础形象生成
metaData: art_skills
---
...
- 必须保持“high-contrast pose-driven manga”和“2D 动画 / 插画”媒介边界。
- 人物需具备清晰身份、年龄、性别、五官、体态、发型、基础服装和气质标签。

## 二、提示词模板

{性别}角色四视图设定图，2D高对比姿态漫画，high-contrast pose-driven manga，dramatic pose, angular face, muscular silhouette, ornate costume，
...
(worst quality, low quality:1.4), blurry, messy lineart, bad anatomy, 3D render, photorealistic, CGI, watermark, signature, text, soft cute moe, minimalist flat style, weak pose, bad anatomy, deformed face, asymmetrical eyes, extra limbs, missing limbs, fused fingers, cropped head, cropped feet, inconsistent identity, inconsistent clothing.
