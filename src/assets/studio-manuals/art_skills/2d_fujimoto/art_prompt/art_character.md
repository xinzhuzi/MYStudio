---
name: art_character
description: 2D电影感松散漫画 · 角色基础形象生成
metaData: art_skills
---
...
- 必须保持“loose cinematic manga drawing”和“2D 动画 / 插画”媒介边界。
- 人物需具备清晰身份、年龄、性别、五官、体态、发型、基础服装和气质标签。

## 二、提示词模板

{性别}角色四视图设定图，2D电影感松散漫画，loose cinematic manga drawing，sketchy linework, casual pose, realistic emotional beat, movie-like composition，
