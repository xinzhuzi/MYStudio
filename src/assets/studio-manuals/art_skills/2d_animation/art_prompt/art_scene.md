...
2D动画场景主视图概念图，clean 2D anime animation style，clean lineart, flat color, expressive eyes, balanced character design，
{室内/室外}，{场景类型}，{时代/地域/题材线索}，{季节+时间}，
前景：{元素}，中景：{元素}，后景：{元素}，
sky blue, warm skin tone, vivid accent，soft animation lighting, clear cel shadow, readable composition，smooth digital paint, crisp outline, controlled detail density，
...
(worst quality, low quality:1.4), blurry, messy lineart, bad anatomy, 3D render, photorealistic, CGI, watermark, signature, text, 3D render, photorealistic, messy sketch, no depth, flat lighting, empty white background, people, human silhouette, cropped architecture, inconsistent season, text, watermark.
