...
Use this Prompt Guide when the user wants:
...
This Prompt Guide's default delivery is **with collage SFX, and without BGM, voiceover, or subtitles**.
...
## STEP 2: Production Plan Document
...
## STEP 4: Final Still-Frame Requirements
