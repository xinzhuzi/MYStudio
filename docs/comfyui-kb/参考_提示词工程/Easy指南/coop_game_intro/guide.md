---
name: co-op-game-intro-prompt-guide
...
If either template is unavailable, stop and report that the Prompt Guide package is incomplete instead of improvising a different prompt structure.

## STEP 1: Resolve the visual style
...
## STEP 6: Refill the Minimax H3 video prompt
