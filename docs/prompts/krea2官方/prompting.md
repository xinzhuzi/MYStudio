...
示例图 `takeoff`：原文路径 `../assets/samples/takeoff.png`；此摘录未附该图片。
...
示例图 `3d`：原文路径 `../assets/samples/3d.png`；此摘录未附该图片。
...
示例图 `blocks`：原文路径 `../assets/samples/blocks.png`；此摘录未附该图片。
...
示例图 `anime`：原文路径 `../assets/samples/anime.png`；此摘录未附该图片。
...
示例图 `beach`：原文路径 `../assets/samples/beach.png`；此摘录未附该图片。
...
示例图 `dog`：原文路径 `../assets/samples/dog.png`；此摘录未附该图片。
...
示例图 `flowers`：原文路径 `../assets/samples/flowers.png`；此摘录未附该图片。
...
示例图 `mouse`：原文路径 `../assets/samples/mouse.png`；此摘录未附该图片。
...
示例图 `sailor`：原文路径 `../assets/samples/sailor.png`；此摘录未附该图片。
...
示例图 `ride`：原文路径 `../assets/samples/ride.png`；此摘录未附该图片。
...
示例图 `statue`：原文路径 `../assets/samples/statue.png`；此摘录未附该图片。
...
示例图 `fox`：原文路径 `../assets/samples/fox.png`；此摘录未附该图片。
...
示例图 `future`：原文路径 `../assets/samples/future.png`；此摘录未附该图片。
...
示例图 `goldface`：原文路径 `../assets/samples/goldface.png`；此摘录未附该图片。
...
示例图 `jester`：原文路径 `../assets/samples/jester.png`；此摘录未附该图片。
...
示例图 `red`：原文路径 `../assets/samples/red.png`；此摘录未附该图片。
...
示例图 `tree`：原文路径 `../assets/samples/tree.png`；此摘录未附该图片。
...
示例图 `cel`：原文路径 `../assets/samples/cel.png`；此摘录未附该图片。
...
示例图 `wind`：原文路径 `../assets/samples/wind.png`；此摘录未附该图片。
...
示例图 `face`：原文路径 `../assets/samples/face.png`；此摘录未附该图片。
