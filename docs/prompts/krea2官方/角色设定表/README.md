...
| [3_通用写法母版/](3_通用写法母版/) | **Krea 官方 CharacterSheets 四型写法标准(2026-05,最高权威)** + Niji 母版 + GPT-Image2 身份锚点法 | 跨模型通用的设定表写法纪律;写三视图/表情格/换装/美宣前先过官方标准 |
| [4_云端模型参考/](4_云端模型参考/) | Nano Banana 三份大全(162条中文全集/10.3k★英文精选/中文玩法) | 云端一致性模型的参考素材,与本地 K2 无关 |

## 写法纪律(2026-09-21 从全库提炼,写提示词前过一遍;09-22 并入 Krea 官方标准)

0. **官方四型模式优先**(Krea 官方 2026-05 指南,见 `3_通用写法母版/Krea官方_CharacterSheets四型写法标准.md`):视图枚举一次且描述性("shown from four angles — front view, …"),零计数断言(不写"恰N格/无第N+1格"),零否定式;一致性靠"角色描述锁死"而非"保持一致"类指令;跨格像素级一致 t2i 做不到(官方明示),要么接受视觉一致,要么正面图当参考图/训 LoRA;调色板每角色 3-5 个颜色词跨 sheet 复用。
