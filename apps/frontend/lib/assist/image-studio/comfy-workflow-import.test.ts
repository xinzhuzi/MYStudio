...
import krea2T2i from "../../../../backend/engines/comfyui/workflows/1_图片/K2图像/1_文生图/krea2-t2i.json";
import krea2NsfwPro from "../../../../backend/engines/comfyui/workflows/1_图片/K2图像/1_文生图/krea2-nsfw-pro.json";
import krea2UnclothInstruct from "../../../../backend/engines/comfyui/workflows/1_图片/K2图像/3_改图/krea2-uncloth-instruct.json";
import krea2EditRef from "../../../../backend/engines/comfyui/workflows/1_图片/K2图像/3_改图/krea2-edit-ref.json";
