...
import type { AIScene, AIScreenplay, GenerationConfig } from '@/lib/ai/core';
import type { CancelCommand, GenerateScreenplayCommand, WorkerCommand, WorkerEvent } from '@/lib/ai/core/protocol';
