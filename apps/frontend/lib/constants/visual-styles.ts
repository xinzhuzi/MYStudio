...
const STYLES_2D: StylePreset[] = [
  ...
  },
  {
    ...
    category: '2d',
    mediaType: 'graphic',
    prompt: 'Chinese 2D colored gongbi illustration. Medium rules take priority over any reference image digital rendering, lighting, or material. Use line-first continuous baimiao and iron-wire outlines for face, hands, hair, garment seams, folds, ornaments, objects, and architectural edges; keep the subject dense and the background sparse. Apply transparent layered mineral washes and glazing on a smooth pale matte flat-wash ground with even flat diffuse illumination. Ink-first with restrained color accents and archaic unity: color hue follows subject and source facts, at most two or three restrained mineral accents from stone blue, stone green, indigo, jade green, ochre, cinnabar, and old gold; avoid washed-out greyscale monochrome or full-frame saturation. Low-noise rendering with denoised fine detail, clear legible surfaces, smooth matte finish, and controlled ink wash; clean finished image, balanced warm and cool accents, intact wearable clothing with complete hems and sleeves.',
    negativePrompt: 'blurry image, messy or broken linework, bad anatomy, extra limbs, photorealistic photography, 3D render, CGI, plastic skin, western oil painting, neon color, cel shading, broad dark value blocks, heavy airbrushed volume, cinematic volumetric fog, cinematic lighting, three-point Hollywood lighting, HDR highlights, wet mirror reflections, full-frame cyan or blue-grey rendering, washed-out greyscale monochrome, paper-wrinkle texture, crumpled-sheet folds, fiber streaks, scanned-paper filter, dirty/muddy texture, visual noise, compression artifacts, jpeg artifacts, oversharpening halos, random stains, messy lineart, watermark, signature, logo, text, incomplete clothing, broken hems, tattered rags, cropped body',
    description: '工笔国画风格，先线后色、矿物分染、水墨为主彩色点缀、浅净平涂底与均匀平光、完整衣物。',
