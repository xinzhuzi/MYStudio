// 09-06 自 components/panels/studio/ 下沉(stores 不得 import panels 的硬性分层):
// 纯函数、零 React/零 store 运行时依赖;下方 import type 仅为复用 store 域类型,
// 运行时被擦除、无环。消费方:stores/studio/image-workflow-slice、panels/studio/workbench-status。
