...
export type ImageGenModelId = "qwen-image-edit-2511" | "z-image-turbo" | "flux2-klein-9b" | "krea2-turbo" | "comfyui-bridge";
...
function isModel(value: unknown): value is ImageGenModelId {
  return value === "qwen-image-edit-2511" || value === "z-image-turbo" || value === "flux2-klein-9b" || value === "krea2-turbo" || value === "comfyui-bridge";
}
