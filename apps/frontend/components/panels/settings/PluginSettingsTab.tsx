      ...
      <div className="p-8 w-full max-w-[1600px] mx-auto space-y-8">
        ...
        <CapabilityGroup label="图像能力">
          ...
          <CapabilityRow
            ...
            icon={ImageIcon}
            title="本地图片生成（免费）"
            description="本地生图零 API 费用，多引擎可选：FLUX.2 Klein 9B（主力，人物/参考图编辑已验证）/ Krea2 Turbo（快速出图+LoRA 可选,人物面部有色彩污染待修）/ Z-Image-Turbo / Qwen-Image-Edit 2511（编辑级）。大件直接复用 ComfyUI 现成文件零重下，小件仅首次点击补齐（数百 MB）。准备运行时后，在 设置 → 云端AI 中将「角色生图 / 场景生图 / 道具生图」绑定到「本地图片生成」提供方，即可替代云 API。"
            pill={imageGenPill}
