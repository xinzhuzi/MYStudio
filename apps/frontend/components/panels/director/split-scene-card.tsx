      ...
      />
        ...
        <ScenePromptPanel
          ...
          onSaveImage={(prompt, promptZh) => {
            ...
            toast.success(`分镜 ${scene.id + 1} 首帧${promptLanguage === "en" ? "英文" : "中文"}提示词已更新`);
          }}
          onSaveEndFrame={(prompt, promptZh) => {
            onUpdateEndFramePrompt(scene.id, prompt, promptZh);
            toast.success(`分镜 ${scene.id + 1} 尾帧${promptLanguage === "en" ? "英文" : "中文"}提示词已更新`);
          }}
          onSaveVideo={(prompt, promptZh) => {
            onUpdateVideoPrompt(scene.id, prompt, promptZh);
            toast.success(`分镜 ${scene.id + 1} 视频${promptLanguage === "en" ? "英文" : "中文"}提示词已更新`);
          }}
        />
