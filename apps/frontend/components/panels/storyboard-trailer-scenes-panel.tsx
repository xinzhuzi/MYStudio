...
export type StoryboardTrailerScenesPanelProps = StoryboardTrailerToolbarProps & {
...
export type SClassTrailerScenesPanelProps = StoryboardTrailerScenesPanelProps;

export function StoryboardTrailerScenesPanel({
  trailerScenes,
  isGenerating,
  renderSceneCard,
  headerActions,
...
export function SClassTrailerScenesPanel(props: SClassTrailerScenesPanelProps) {
  return <StoryboardTrailerScenesPanel {...props} />;
}
