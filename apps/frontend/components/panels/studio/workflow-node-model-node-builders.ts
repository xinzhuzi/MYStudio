...
import {
  ...
  type ProductionFlowRemotionSummary,
  type ProductionFlowRendererSummary,
  type ProductionFlowStoryboardTile,
...
export function buildScriptNode(ctx: ProductionFlowBuildContext): ProductionFlowNodeModel {
  return {
    id: "script",
    label: "剧本",
...
export function buildScriptPlanNode(ctx: ProductionFlowBuildContext): ProductionFlowNodeModel {
  return {
    id: "scriptPlan",
    label: "导演规划",
...
export function buildAssetsNode(ctx: ProductionFlowBuildContext): ProductionFlowNodeModel {
  return {
    id: "assets",
    label: "衍生资产",
...
export function buildStoryboardTableNode(ctx: ProductionFlowBuildContext): ProductionFlowNodeModel {
  return {
    id: "storyboardTable",
    label: "分镜表",
...
export function buildStoryboardPanelNode(ctx: ProductionFlowBuildContext): ProductionFlowNodeModel {
  return {
    id: "storyboard",
    label: "分镜面板",
...
export function buildRemotionProductionNode(ctx: ProductionFlowBuildContext): ProductionFlowNodeModel {
...
export function buildWorkbenchNode(ctx: ProductionFlowBuildContext): ProductionFlowNodeModel {
  const summary = ctx.remotionSummary;
  return {
    id: "workbench",
...
export function buildStoryboardTiles(
...
export function buildRemotionShots(
  chapterStoryboards: StoryboardItem[],
...
export function summarizeRemotionShots(
