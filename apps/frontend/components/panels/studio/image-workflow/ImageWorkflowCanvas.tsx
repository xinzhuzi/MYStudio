...
export function ImageWorkflowCanvas({
  ...
  const { handleCropConfirm, handleExtractEntry, handleSplitConfirm, handleMaskConfirm, runReversePrompt } = useImageCanvasProcessing({
    cropTarget, setCropTarget, splitTarget, setSplitTarget, maskTarget, setMaskTarget,
    reverseState, setReverseState, activeGraph, selectedNodeId, saveGraph, landDerived, assertLanded, generateNode,
  });
