...
13. **逐镜出镜语义不可省略**：每一镜必须在表格的 `出镜语义JSON` 列写出本镜的 `sceneViewpointId`、真正可见的人物和真正可见的道具，而不是复用场头的全部参演角色或片段资产。每个入画角色都必须有名称、九宫格站位、朝向、入镜动作和出镜动作；每个可见道具都必须有名称、位置和本镜状态；没有任何人物或道具时分别写空数组。没有人物时只能明确写 `personFree:true`，禁止用空数组、`无` 或省略字段来猜测空镜。角色和道具名称必须来自本镜 `引用资产名称`，不得以台词说话人、场头演员表或未出镜资产推断入画。
...
|------|------|------|------|------|------|------|------|
| 1 | 西瓜筐被一脚踢飞腾空，筐内西瓜飞溅而出，西瓜在林志强脚边砸地炸裂，红瓤四溅，黄土扬起。 | 5 | 近景 | 缓推 | 旁白：西瓜在林志强脚边砸裂。 | 音效：西瓜筐翻滚撞地声、西瓜炸裂闷响、瓜瓤溅落声 | {"sceneViewpointId":"yard-gate-axis","personFree":false,"visibleCharacters":[{"name":"林志强","position":"右中格","orientation":"正面三分之四朝左","actionIn":"右脚停在落点旁，低头看向飞来的西瓜","actionOut":"侧身避开碎瓤，右脚仍停在原地"}],"visibleProps":[{"name":"西瓜筐","position":"左前景","state":"翻起并倾倒"}],"actionIn":"西瓜筐从左前景翻起，林志强位于右中格","actionOut":"碎瓤落到林志强右脚边","transitionToNext":{"styleWord":"同场景硬切","moodWord":"战斗"}} |
| 2 | 林刚抬手食指直逼林志强眉心，下巴绷紧，横肉随怒气抖动，眼神戾气满溢。 | 5 | 近景 | 缓推 | 林刚：你到底打算吸我们的血到什么时候？ | 音效：手指划风声、急促呼吸声 | {"sceneViewpointId":"yard-gate-axis","personFree":false,"visibleCharacters":[{"name":"林刚","position":"左中格","orientation":"正面三分之四朝右","actionIn":"右臂从胸前抬起，食指指向林志强","actionOut":"食指停在眉心前，肩背绷紧"},{"name":"林志强","position":"右中格","orientation":"正面三分之四朝左","actionIn":"侧身站定，视线落在林刚手指上","actionOut":"不后退，保持与林刚对视"}],"visibleProps":[],"actionIn":"承接上一镜碎瓤落地后的对峙","actionOut":"两人保持相向站位，林刚的手指停在画面中央","transitionToNext":{"styleWord":"水墨晕染","moodWord":"战斗"}} |
```
