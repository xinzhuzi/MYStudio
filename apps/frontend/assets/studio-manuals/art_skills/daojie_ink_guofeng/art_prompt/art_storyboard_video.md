...
## 连环画叙事层（09-18《三国望神州》DNA 并入；09-18 实证校正）

> **权重校正（官方截图实证）**：「连环画」「剪纸画」=官方营销词，当叙事气质参考不作硬约束；游戏实况主视图=三维等距+青绿淡彩+水墨笔触混合，特效为高饱和游戏级（「猛火计」演出实证）。战斗演出镜头**豁免 X6 堆料黑名单**——强度走动态层，线色体系恒定。

- **叙事画面感**：分镜人物处在具体历史事件中（对峙/交谈/行军/骑马/战斗/谋划/观景/入城/祭拜/送别择一），不摆拍——连环画语言=叙事优先
- **双层口径**：静态美术层=素雅克制疏朗古典工笔传统色；动态叙事层（战斗/技能演出）可临时提高动作强度与分镜张力（速度线/特写/强调姿态/墨色笔触强化），但**基础色彩与线条体系不变**——传统色与工笔线是恒定 DNA,强度只走动态层
- **构图疏密**：主体明确、次要元素围绕、背景不抢戏、远景降细节、前中后景节奏、允许画面「空」——禁「电影海报式堆满」（人物巨大+龙+云海+金光+特效齐上）
