...
- **禁用色域**：soft modern moe face, photorealistic 3D, weak anatomy。
...
- **质感锚点**：solid ink line, simple color blocks, crisp anatomy detail。
- **提示词基线**：(best quality, masterpiece, high detailed:1.2), (classic round-line shonen manga:1.3), (rounded expressive face, athletic body, clear action pose, iconic simple costume:1.18), (bright outdoor light, high readability, clean shadow:1.1), solid ink line, simple color blocks, crisp anatomy detail, clean composition, readable silhouette, high detail, finished illustration。
