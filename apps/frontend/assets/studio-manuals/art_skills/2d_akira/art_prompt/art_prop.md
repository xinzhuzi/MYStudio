...
2D热血圆线漫画道具设定图，classic round-line shonen manga，rounded expressive face, athletic body, clear action pose, iconic simple costume，
...
(worst quality, low quality:1.4), blurry, messy lineart, bad anatomy, 3D render, photorealistic, CGI, watermark, signature, text, soft modern moe face, photorealistic 3D, weak anatomy, hands, fingers, human body, worn by character, held by character, floating without support, unclear silhouette, wrong material, text, watermark.
