...
毛绒定格动画场景主视图概念图，needle-felt stop-motion animation，wool character, fuzzy miniature prop, handmade craft environment，
{室内/室外}，{场景类型}，{时代/地域/题材线索}，{季节+时间}，
前景：{元素}，中景：{元素}，后景：{元素}，
warm beige, wool brown, pastel accent，warm diffuse light, soft fabric shadow, cozy atmosphere，visible wool fibers, felt texture, stitched handmade detail，
...
(worst quality, low quality:1.4), fluid CGI animation, 2D anime, photorealistic human scale, smooth digital texture, bad anatomy, watermark, signature, text, hard plastic, shiny metal, 2D anime, photorealistic human, no depth, flat lighting, empty white background, people, human silhouette, cropped architecture, inconsistent season, text, watermark.
