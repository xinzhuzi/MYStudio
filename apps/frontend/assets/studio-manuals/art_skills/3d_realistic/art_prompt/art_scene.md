...
3D写实场景主视图概念图，photorealistic 3D cinematic render，highly detailed texture, realistic skin shader, complex fabric, accurate scale，
{室内/室外}，{场景类型}，{时代/地域/题材线索}，{季节+时间}，
前景：{元素}，中景：{元素}，后景：{元素}，
neutral film grade, slate grey, warm highlight，ray-traced lighting, cinematic depth of field, controlled contrast，micro surface detail, natural imperfections, realistic material response，
