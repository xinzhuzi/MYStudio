...
3D写实道具设定图，photorealistic 3D cinematic render，highly detailed texture, realistic skin shader, complex fabric, accurate scale，
...
(worst quality, low quality, bad quality:1.4), blurry, fuzzy, distorted, out of focus, malformed body, extra limbs, watermark, signature, text, cartoon, anime, flat illustration, low poly, plastic skin, hands, fingers, human body, worn by character, held by character, floating without support, unclear silhouette, wrong material, text, watermark.
