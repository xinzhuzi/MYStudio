...
2D电影感松散漫画场景主视图概念图，loose cinematic manga drawing，sketchy linework, casual pose, realistic emotional beat, movie-like composition，
{室内/室外}，{场景类型}，{时代/地域/题材线索}，{季节+时间}，
前景：{元素}，中景：{元素}，后景：{元素}，
muted grey, warm brown, faded blue，natural side light, muted contrast, grounded atmosphere，rough ink texture, visible hand-drawn marks, restrained color，
...
(worst quality, low quality:1.4), blurry, messy lineart, bad anatomy, 3D render, photorealistic, CGI, watermark, signature, text, over-polished digital gloss, standard cute anime, 3D render, no depth, flat lighting, empty white background, people, human silhouette, cropped architecture, inconsistent season, text, watermark.
