...
2D电影场景主视图概念图，high budget 2D animated movie still，detailed background, emotional sky, cinematic character framing, atmospheric depth，
{室内/室外}，{场景类型}，{时代/地域/题材线索}，{季节+时间}，
前景：{元素}，中景：{元素}，后景：{元素}，
golden sunset, deep blue, soft cloud white，dramatic sunset light, layered clouds, soft glow，painterly background, clean character line, film-like composition，
...
(worst quality, low quality:1.4), blurry, messy lineart, bad anatomy, 3D render, photorealistic, CGI, watermark, signature, text, simple flat cartoon, low resolution, dull color, no depth, flat lighting, empty white background, people, human silhouette, cropped architecture, inconsistent season, text, watermark.
