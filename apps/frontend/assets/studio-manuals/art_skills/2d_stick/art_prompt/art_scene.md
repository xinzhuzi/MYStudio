...
2D简笔画场景主视图概念图，minimalist stick figure doodle，simple stick figure, sketchbook charm, clean blank space, cute expression，
{室内/室外}，{场景类型}，{时代/地域/题材线索}，{季节+时间}，
前景：{元素}，中景：{元素}，后景：{元素}，
black line, white, tiny color accent，flat paper light, no complex shadow, minimal contrast，hand-drawn pencil line, plain white background, sparse detail，
