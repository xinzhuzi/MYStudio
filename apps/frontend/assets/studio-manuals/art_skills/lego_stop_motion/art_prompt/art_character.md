...
- 生成 定格角色设定图，用于角色首次定型。
- 必须保持“brick toy stop-motion animation”和“定格动画”媒介边界。
- 人物需具备清晰身份、年龄、性别、五官、体态、发型、基础服装和气质标签。

## 二、提示词模板

{性别}角色四视图设定图，积木定格动画，brick toy stop-motion animation，block figure, construction bricks, modular toy town, snapped-together props，
...
macro toy light, crisp shadow, colorful plastic reflection，hard plastic brick surface, molded studs, clean toy edges，primary red, blue, yellow，
...
(worst quality, low quality:1.4), fluid CGI animation, 2D anime, photorealistic human scale, smooth digital texture, bad anatomy, watermark, signature, text, soft clay, melted curved shapes, realistic human body, bad anatomy, deformed face, asymmetrical eyes, extra limbs, missing limbs, fused fingers, cropped head, cropped feet, inconsistent identity, inconsistent clothing.
