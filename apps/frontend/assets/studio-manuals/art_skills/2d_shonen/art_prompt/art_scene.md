...
2D热血动画场景主视图概念图，dynamic shonen action anime，impact pose, speed lines, intense expression, powerful silhouette，
{室内/室外}，{场景类型}，{时代/地域/题材线索}，{季节+时间}，
前景：{元素}，中景：{元素}，后景：{元素}，
red, black, bright yellow，strong contrast light, dramatic action shadow, burst effect，bold cel shading, sharp line weight, energetic detail，
...
(worst quality, low quality:1.4), blurry, messy lineart, bad anatomy, 3D render, photorealistic, CGI, watermark, signature, text, static calm pose, soft shoujo mood, pastel quiet scene, no depth, flat lighting, empty white background, people, human silhouette, cropped architecture, inconsistent season, text, watermark.
