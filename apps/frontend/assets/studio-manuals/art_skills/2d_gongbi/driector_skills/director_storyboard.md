...
| 情绪 | 面容/主体 | 光影 | 镜头建议 |
|---|---|---|---|
| 温柔 | 目光柔和、动作克制 | soft paper light, delicate highlight, calm atmosphere 的柔化版本 | 中近景，缓慢推近 |
...
(worst quality, low quality:1.4), blurry, messy lineart, bad anatomy, 3D render, photorealistic, CGI, watermark, signature, text, western oil painting, neon color, rough sketch, 3D realism, subtitles, captions, watermark, title overlay, UI text

## 禁止项

- 直接照搬具体作品、作者、厂牌或版权角色。
- western oil painting, neon color, rough sketch, 3D realism。
