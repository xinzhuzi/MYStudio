...
- **禁用色域**：modern glossy digital art, 3D render, hyper sharp HDR。
...
- **质感锚点**：cel paint texture, slight VHS softness, hand-painted backdrop。
- **提示词基线**：(best quality, masterpiece, high detailed:1.2), (1990s hand-drawn cel animation:1.3), (retro character design, matte painted background, nostalgic framing:1.18), (soft analog glow, mild film grain, warm evening light:1.1), cel paint texture, slight VHS softness, hand-painted backdrop, clean composition, readable silhouette, high detail, finished illustration。
