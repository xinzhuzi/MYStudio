...
2D橡皮管动画，1930s rubber hose cartoon，{时段/天候/景别变化}，{氛围强化}，
...
(worst quality, low quality:1.4), blurry, messy lineart, bad anatomy, 3D render, photorealistic, CGI, watermark, signature, text, modern anime, realistic 3D, stiff motion, changed location, lost landmark, added people, random architecture, inconsistent perspective, flat lighting, overclean material, text, watermark.
