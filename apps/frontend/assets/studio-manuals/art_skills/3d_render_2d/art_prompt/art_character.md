...
- 必须保持“anime-inspired cel shaded 3D render”和“3D 渲染”媒介边界。
- 人物需具备清晰身份、年龄、性别、五官、体态、发型、基础服装和气质标签。

## 二、提示词模板

{性别}角色四视图设定图，3D渲染2D，anime-inspired cel shaded 3D render，toon linework, cel shaded body, vibrant fantasy setting, clean anime face，
