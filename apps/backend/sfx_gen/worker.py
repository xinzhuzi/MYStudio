"""CLI 服务面(spawn 面:python -m sfx_gen.worker)。

推理底层已拆至 engines/sfx_engine/(09-09 引擎层统一);本文件只留
...
from engines.sfx_engine.generate import DEFAULT_MODEL, SfxGenError, generate_sfx
from engines.sfx_engine.model_cache import (
    MAX_SFX_DURATION_S,
    MIN_SFX_DURATION_S,
    SFX_MODELS,
