#!/usr/bin/env python3
"""Explicit audio model downloader. Usage:
  python -m audio_gen.download_model --model musicgen-small --progress <progress.json>
"""
...
from engines.audio_engine.model_cache import AUDIO_MODELS, primary_hf_cache_dir, repo_cache_dir
...
def main() -> None:
    parser = argparse.ArgumentParser(description="MYStudio audio model downloader")
