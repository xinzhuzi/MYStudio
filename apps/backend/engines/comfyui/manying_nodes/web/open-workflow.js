 ...
 * window.__manyingOpenWorkflow 锚=ComfyCanvasStudio 探测助手契约。
 */
...
export { MANYING_STORE_BASE, cloneGraph, closeStaleWorkflows, mainlineTabMatcher, openWorkflowSingleInstance, cleanupLegacyUnsavedTabs };
