...
class ChapterVideoGongbiV2Test(unittest.TestCase):
    ...
    def test_prompt_audit_requires_v2_markers_and_rejects_legacy_art_direction(self) -> None:
        ...
        self.assertEqual(passed["version"], "gongbi-v3-prompt-audit-v1")
    ...
    def test_color_audit_keeps_single_hue_diagnostics_soft_below_color_forward_threshold(self) -> None:
        with tempfile.TemporaryDirectory() as temp:
            ...
            self.assertIn("chapter_video_gongbi_restyle.py:audit_polychrome_image", report["sourceProvenance"])
