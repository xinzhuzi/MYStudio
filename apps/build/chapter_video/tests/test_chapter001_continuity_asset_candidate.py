...
from apps.build.chapter_video.pipeline import build_chapter001_reference_replacement_manifests as builder
from apps.build.chapter_video.pipeline import chapter001_continuity_asset_candidate as contract
from apps.build.chapter_video.pipeline import gongbi_v2 as v2
...
class Chapter001ContinuityAssetCandidateTest(unittest.TestCase):
    ...
    def test_builds_three_unique_compact_jobs_without_paid_authorization(self) -> None:
        ...
        self.assertEqual(
            ...
            "gongbi-v3-reference-replacement-v1",
        )
        self.assertEqual(
    ...
    def test_replacement_prompt_audit_rejects_the_consumed_bloated_prompt(self) -> None:
        prior_plan = json.loads(
            (
                builder.TASK_DIR
                / "research/gongbi-v2-shot001-reference-replacement-plan-20260723-r02.json"
    ...
    def test_rejects_forged_replacement_audit_and_contract_revision_drift(self) -> None:
        ...
        revision_drift["promptContractRevision"] = "gongbi-v2-reference-replacement-v1"
