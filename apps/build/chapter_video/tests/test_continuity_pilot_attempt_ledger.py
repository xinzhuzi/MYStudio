...
class ContinuityPilotAttemptLedgerTest(unittest.TestCase):
    ...
    def test_v2_human_approval_requires_the_complete_visual_checklist(self):
        ...
        with tempfile.TemporaryDirectory() as temp:
            ...
            report["entries"][0]["styleContractVersion"] = "gongbi-v2"
            ...
            checklist = {
                field: True
                for field in module.gongbi_v2.HUMAN_REVIEW_CHECKLIST_FIELDS
            }
        ...
        with tempfile.TemporaryDirectory() as temp:
            ...
            with self.assertRaisesRegex(RuntimeError, "旧风格镜头"):
                module.previous_approved_frame_manifest(
                    ...
                    {
                        "outputPath": str(image_path),
                        "styleContractVersion": "chapter_video-gongbi-v1",
                    },
    ...
    def test_v2_capability_summary_stays_blocked_without_provider_evidence(self):
        ...
        report = module.summarize_reference_capabilities([{
            ...
            "referenceCapability": {
                "schemaVersion": module.gongbi_v2.REFERENCE_CAPABILITY_SCHEMA_VERSION,
                "status": "unverified",
    ...
    def test_v2_capability_summary_blocks_verified_model_over_its_reference_limit(self):
        ...
        capability = {
            ...
            "referenceRoleOrder": list(module.gongbi_v2.REFERENCE_ROLE_ORDER),
            "evidence": {
                "kind": "test",
    ...
    def test_paid_attempt_metadata_reaches_the_gpt_request_config(self):
        ...
        with tempfile.TemporaryDirectory() as temp:
            with patch.dict(os.environ, {
                "MYSTUDIO_CHAPTER_VIDEO_STORYBOARD_IMAGE_MODE": "real-ai-reference-image-workflow",
                ...
                return_value=generator.with_gongbi_v2_contract({
                    "providerName": "mikoto",
                    "baseUrl": "https://api.mikoto.vip/v1",
                    "apiKey": "test-key",
                    "apiKeys": ["test-key"],
        ...
        self.assertEqual(observed["logicalJob"], "chapter001-continuity-pilot")
