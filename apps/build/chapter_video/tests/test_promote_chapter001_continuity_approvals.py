...
from apps.build.chapter_video.pipeline.promote_chapter001_continuity_approvals import (
    MAX_EVIDENCE_BYTES,
...
SCRIPT_PATH = REPOSITORY_ROOT / "apps/build/chapter_video/pipeline/promote_chapter001_continuity_approvals.py"
...
class PromoteHumanApprovedCandidateTest(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self.review_path.write_text(json.dumps({
            "schemaVersion": "chapter_video-continuity-asset-review-v1",
        ...
        self.approval_path.write_text(json.dumps({
            "schemaVersion": "chapter_video-continuity-asset-human-approval-v1",
