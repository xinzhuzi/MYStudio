...
const V2_STYLE_CONTRACT_VERSION = "gongbi-v3";
// v2 台账/存量请求仍被接受;契约本体已在 v3 升级(MA ma-gongbi-v1 对齐:浅净平涂底/色量观察口径)。
const V2_STYLE_CONTRACT_VERSIONS = new Set(["gongbi-v2", "gongbi-v3"]);
const isReviewedStyleContractVersion = (value) => V2_STYLE_CONTRACT_VERSIONS.has(value);
const REFERENCE_CAPABILITY_SCHEMA_VERSION = "chapter_video-reference-capability-v1";
