...
from apps.build.chapter_video.build_chapter001_workflow import (  # noqa: E402
...
from apps.build.chapter_video.path_resolver import resolve_project_dir  # noqa: E402
from apps.build.chapter_video.pipeline.prepare_chapter001_continuity_bibles import (  # noqa: E402
...
CANDIDATE_REVIEW_SCHEMA_VERSION = "chapter_video-continuity-asset-review-v1"
CANDIDATE_APPROVAL_SCHEMA_VERSION = "chapter_video-continuity-asset-human-approval-v1"
...
def promote_human_approved_candidate(
    ...
    *,
    ...
    bible_root = store_path.parent / f"continuity-bibles/{EPISODE_ID}/{BIBLE_VERSION}"
    planned_version = {
        "assetId": asset_id,
