...
const logoPath = fileURLToPath(new URL("../../frontend/assets/brand/logo.png", import.meta.url));
const dragonSourcePath = fileURLToPath(new URL("../../frontend/assets/brand/dragon-emblem-source.png", import.meta.url));
