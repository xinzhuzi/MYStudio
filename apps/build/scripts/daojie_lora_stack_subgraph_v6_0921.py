...
COL_GAP = 270          # loader 列距(节点宽~230)
ROW_GAP = 180          # 行距(组高~150+间30)
START_X, START_Y = 40, 40
EXEC_X, EXEC_W, EXEC_H = 1780, 400, 780
...
def main():
    ...
    nodes.append({
        ...
        "title": "▶ 自动档·跟随[80]选型(手动档=改接左侧任一行)",
    ...
    for row, zh in enumerate(NINE):
        ...
        groups.append({
            ...
            "bounding": [START_X - 8, y - 6, cols * COL_GAP - (COL_GAP - 230) + 22, 156],
