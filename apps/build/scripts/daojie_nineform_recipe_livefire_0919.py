...
SUBJECTS = {
    ...
    "三视图": "同一位玄色劲装的青年刀修全身三视图：正面按刀垂立，侧面抱刀而立，背面负刀远望；三个视角姿态自然舒展，服饰纹样、配饰与发型在视角间完全一致。",
    "高清人脸": "一位驻颜有素的女修面容特写：眉如远山含黛，眼尾微挑，瞳色深棕近黑，鼻梁挺秀，唇色淡朱；神情是劫后余生的平静，几缕碎发贴在微汗的额角，柔和顶光勾勒出面部的立体轮廓。",
    "分镜剧情图": "山雨欲来的渡口，老船工收篙回望，身后的少年修士第一次背起行囊离乡；乌云压江，渡口一盏灯笼是画面唯一的暖色，两人的目光都投向江雾深处若隐若现的仙山轮廓。",
    "表情差分": "同一位红衣女修的五格表情差分：平静垂目、含笑不语、怒目剑眉、痛楚闭眼、决然睁眼；各格头部角度与光源方向保持一致，只有神态与眉眼唇形变化。",
