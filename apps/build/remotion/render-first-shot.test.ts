...
async function loadPreviewSourceFixture(): Promise<FirstShotSource> {
    return {
      ...
      imagePath: `${PROJECT_ROOT}/backups/legacy-pipeline/exports/chapter-001/storyboard-frames/shot-001.png`,
      imageSha256: PRODUCTION_IMAGE_SHA256,
      audioPath: `${PROJECT_ROOT}/backups/legacy-pipeline/exports/chapter-001/voice-audio/shot-001.wav`,
...
function validCleanReport(): Record<string, unknown> {
  ...
  Object.assign(source, {
    ...
    imageSha256: A08_IMAGE_SHA256,
    productionImage: {
      path: `${PROJECT_ROOT}/backups/legacy-pipeline/exports/chapter-001/storyboard-frames/shot-001.png`,
      sha256: SHA,
    },
    candidate: {
      reportPath: `${A08_ROOT}/report.json`,
