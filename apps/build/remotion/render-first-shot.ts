...
const imagePath = path.join(projectRoot, "backups/legacy-pipeline/exports/chapter-001/storyboard-frames/shot-001.png");
const audioPath = path.join(projectRoot, "backups/legacy-pipeline/exports/chapter-001/voice-audio/shot-001.wav");
