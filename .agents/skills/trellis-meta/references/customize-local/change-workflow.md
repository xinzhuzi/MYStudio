...
| `in_progress` | check passed | Phase 3.3 (spec update) → 3.4 (human review) → 3.5 (no-git archive/session) |
| `completed` | task is still in active tree | Phase 3.5 (archive/session with `--no-commit`) |
